...
import { GitBranch, Plus, Save, Play, Trash2, Upload, Download, ChevronRight } from 'lucide-react';
...
function WorkflowEditorInner() {
  const {
    activeWorkflow, isDirty, loading,
    createWorkflow, saveWorkflow, executeWorkflow,
    addNode, addEdge: storeAddEdge, removeNode, removeEdge,
    updateNodePosition, setViewport,
  } = useWorkflowStore();
  ...
  const [rfInstance, setRfInstance] = useState<Parameters<typeof ReactFlow>[0] | null>(null);
  ...
  const onPaneDoubleClick = useCallback(
    (e: React.MouseEvent) => {
      setNodePickerPos({ x: e.clientX - 200, y: e.clientY - 50 });
      ...
      <div className="flex-1 relative">
        {activeWorkflow ? (
          <ReactFlow
            ...
            onPaneClick={() => setShowNodePicker(false)}
